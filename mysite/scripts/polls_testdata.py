...
def import_data():
    ...
    polls_question_1.question_text = u'No No No!'
    polls_question_1.pub_date = dateutil.parser.parse("2017-05-24T07:55:04+00:00")
    ...
    polls_choice_1.choice_text = u'Yes'
    polls_choice_1.votes = 3
    polls_choice_1 = importer.save_or_locate(polls_choice_1)

    polls_choice_2 = Choice()
    polls_choice_2.question = polls_question_1
    polls_choice_2.choice_text = u'No'
    polls_choice_2.votes = 1
    polls_choice_2 = importer.save_or_locate(polls_choice_2)

    polls_choice_3 = Choice()
    polls_choice_3.question = polls_question_1
    polls_choice_3.choice_text = u'Maybe'
    polls_choice_3.votes = 1
